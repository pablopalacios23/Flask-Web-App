const json = {
    ...
    "pages": [
      ...
      "elements": [
       {
        "type": "boolean",
        "name": "q22A",
        "title": "¿Dispone un proceso integral para hacer frente a los incidentes que puedan tener impacto de seguridad en el sistema?",
        "isRequired": true,
        "labelTrue": "Si",
        "valueTrue": "Si",
        "valueFalse": "No"
       },
       {
        "type": "boolean",
        "name": "q22B",
        "title": "¿Dispone de soluciones de ventanilla única para la notificación de incidentes al CNN?",
        "description": "Esta cuestión deberá ser cumplimentada o incluida en la documentación en caso de encontrarnos ante un Esquema Nacional de Seguridad con un nivel de seguridad MEDIA",
        "isRequired": true,
        "labelTrue": "Si",
        "valueTrue": "Si",
     ...
     },
     {
      ...
      "elements": [
       ...
       },
       {
        "type": "boolean",
        "name": "q23A",
        "visibleIf": "{Registro de la actividad} allof ['Aplica']",
        "title": "¿Cuentan con registros de actividad en los servidores?",
        "enableIf": "{Registro de la actividad} allof ['Aplica']",
        "isRequired": true,
        "requiredIf": "{Registro de la actividad} allof ['Aplica']",
        "labelTrue": "Si",
        "valueTrue": "Si",
        "valueFalse": "No"
       },
       {
        ...
        "name": "q23B",
        "visibleIf": "{Registro de la actividad} allof ['Aplica']",
        "title": "¿Se revisan de forma periódica, los registros de actividad, buscando patrones anormales?",
        "description": "Esta cuestión deberá ser cumplimentada o incluida en la documentación en caso de encontrarnos ante un Esquema Nacional de Seguridad con un nivel de seguridad MEDIA",
        "enableIf": "{Registro de la actividad} allof ['Aplica']",
        "isRequired": true,
        "requiredIf": "{Registro de la actividad} allof ['Aplica']",
     ...
     },
     {
      ...
      "elements": [
       {
        "type": "boolean",
        "name": "q24A",
        "title": "¿Cuentan con registro de incidentes?",
        "isRequired": true,
        "labelTrue": "Si",
        "valueTrue": "Si",
        "valueFalse": "No"
      ...
      "title": "Marco operacional",
      "description": "Registro de gestión de incidentes"
     },
     {
      "name": "page25",
      "elements": [
       {
        "type": "checkbox",
        "name": "Protección de claves criptográficas",
       ...
       },
       {
        ...
        "visibleIf": "{Protección de claves criptográficas} allof ['Aplica']",
        "title": "¿Las claves criptográficas se protegerán durante todo su ciclo de vida?",
        "enableIf": "{Protección de claves criptográficas} allof ['Aplica']",
        "isRequired": true,
        "requiredIf": "{Protección de claves criptográficas} allof ['Aplica']",
        "labelTrue": "Si",
        "valueTrue": "Si",
        "valueFalse": "No"
       },
       {
        ...
        "name": "q25B",
        "visibleIf": "{Protección de claves criptográficas} allof ['Aplica']",
        "title": "¿Usan únicamente algoritmos autorizados?",
        "description": "Esta cuestión deberá ser cumplimentada o incluida en la documentación en caso de encontrarnos ante un Esquema Nacional de Seguridad con un nivel de seguridad MEDIA",
        "enableIf": "{Protección de claves criptográficas} allof ['Aplica']",
        "isRequired": true,
        "requiredIf": "{Protección de claves criptográficas} allof ['Aplica']",
